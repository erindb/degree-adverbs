...
We then computed the squared correlation between those values and the surprisal predictor ($R^2=0.293$ for Study 1a, $R^2=0.273$ for Study 1b, and $R^2=0.358$ for Study 2)\footnote{
