...
%, with random by-intensifier intercepts $I_i$ and random by-participant slopes $P_{1j}$ and $P_{2j}$.
...
%In this regression, we did not a significant effect of syllable length ($b=0.133,t(39.9)=1.717,p=0.094$), above and beyond surprisal.
