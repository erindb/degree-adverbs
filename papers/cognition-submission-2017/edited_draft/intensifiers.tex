...
\ndg{doesn't this mean that we do need syllables in addition to surprisal, thus confirming the syllables prediction?}
...
(Despite having sufficient power for the surprisal term, our bootstrapped power analysis suggests that even with 100 participants, the power for the syllables term in the model is only 0.29. We address this instead, with a direct manipulation of syllables, in experiments 4 and 5.)
...
We did not find a significant main effect of syllable length ($b=0.055, t(69.4)=1.021, p=0.311$), above and beyond surprisal.
...
To see the effect of the two measures of communicative cost separately, we compared the full model to a model without that measure as a regressor using a likelihood ratio test.
