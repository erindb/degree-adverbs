...
function get_items() {
  var adverbs_sets = [
    ['most', 'hugely', 'surprisingly', 'very much', 'suspiciously', 'outright', 
    'simply', 'sharply', 'strikingly', 'pretty', 'dead', 'rather', 'highly', 'truly', 
    'easily', 'absolutely', 'amazingly', 'extremely', 'wholly', 'positively', 
    'exceedingly', 'terribly', 'extra'],
    ['considerably', 'completely', 'intensely', 'purely', 'supremely', 'extensively', 
    'unusually', 'so', 'incredibly', 'entirely', 'enormously', 'largely', 
    'extraordinarily', 'noticeably', 'well', 'real', 'very', 'infinitely', 
    'perfectly', 'sufficiently', 'awfully', 'fantastically', 'thoroughly'],
    ['quite', 'plain', 'unbelievably', 'way', 'damn', 'downright', 'mighty', 
    'totally', 'wonderfully', 'deeply', 'greatly', 'badly', 'strongly', 'excessively', 
    'dreadfully', 'remarkably', 'tremendously', 'good and', 'utterly', 'really', 
    'fully', 'altogether', 'too', 'immensely', 'profoundly']
  ];
  ...
  var items = []
  var replication_chunk = _.sample([0, 1, 2]);
  var names = _.shuffle(female_names.concat(male_names));
  var adverbs = adverbs_sets[replication_chunk];
