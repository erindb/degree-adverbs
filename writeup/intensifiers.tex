...
We have identified the intensifier cost, $C(u_{i})$, as a potentially critical factor of it's interpreted meaning. To connect this to empirical facts, we still must specify (at least some of) the factors we expect to impact cost.
%
...
We thus predict that longer and less frequency intensifiers will be more extreme, and that this is a quantitative relationship. 
...
%%%%% make this clearer
\todo{include some of this stuff in conclusion? was above expt 1...}
