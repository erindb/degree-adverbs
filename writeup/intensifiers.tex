...
\todo{need to say why we think frequency and syllable number should be aspects of ``cost''. point out that this leaves open their relative importance, how they combine, and what other factors might enter into cost.}
...
The syllable lenths of our intensifiers and the surprisals \todo{say what surprisal is and why we care before using it.} were correlated, but not strongly so (r = 0.2648144).
...
\todo[inline]{can we do a combined regression where list is a factor (and/or random effect)? rank-within-list would still be the DV. this would allow a common estimate of effect of surprisal across the expt?}
