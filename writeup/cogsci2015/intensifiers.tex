...
%Reviewer 2 notices that by effect of frequent usage, the
%    meaning of high frequency intensifiers might lead to lexicalization.
...
We asked participants to estimate the prices of different objects based on %different
...
% Moreover, it is well known that word frequency and word length do
...
Participants were asked to move the adjective phrases %from the left to the right side of
across 
...
The list-adjective pairings were randomized between participants.%, but %pairings between list and adjective were randomized between participants.
The division of the intensifiers into lists of 10
was constant, so that the same 10 intensifiers were always shown together.% to simplify data analysis.
...
% Fixed effects:
%                          Estimate Std. Error        df t value Pr(>|t|)    
% (Intercept)             5.459e+00  7.983e-02 8.084e+02  68.380  < 2e-16 ***
% c.surprisal             4.323e-01  9.335e-02 4.300e+00   4.631  0.00803 ** 
% c.syllables             6.710e-01  1.220e-01 7.000e+00   5.499  0.00092 ***
% c.surprisal:c.syllables 7.249e-02  3.614e-02 1.048e+03   2.006  0.04516 *  
...
Although the length of a word certainly depends on frequency of use% \cite{zipf}
